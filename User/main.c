...
int   stepPosition, stepPosition_Y, stepPosition_Z, stepPosition_Turn_Z;  //步数计数
int   Turn_Step, duizheng_step_X, duizheng_step_Y;  //步数计数
...
//	Turntable_task_flag = 1;
	...
	while (1)
	{
		...
		switch (map_flag)
		{
			...
			case 50:
			{
					Move_Turn_Z(-2415, 50, 50, 800);			//爪子从蓝色色环转到车上置物台
